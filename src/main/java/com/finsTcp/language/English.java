...
public class English extends DefaultLanguage {
    ...
    @Override
    public String ExceptionSourse() {
        return "Exception Sourse：";
    }
    ...
    @Override
    public String ExceptopnTargetSite() {
        return "Exception Method: ";
    }

    @Override
    public String ExceprionCustomer() {
    ...
    @Override
    public String DataSourseFormatError() {
     ...
     ************************************************************************************/
    @Override
    public String MelsecPleaseReferToManulDocument() {
    ...
    @Override
    public String MelsecFxReceiveZore() {
    ...
    @Override
    public String OmronAddressMustBeZeroToFiveteen() {
